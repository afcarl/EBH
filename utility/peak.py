...
def find_peaks(data, threshold=75, peaksize=10, mindist=10, center=True):
    peak = []
    peaks = []
    inpeak = False
...
def find_peaks_subtract(dw, threshtop=50, threshbot=None, filtersize=0, peaksize=10, mindist=10, center=True):
    ...
    top = find_peaks(data=left, threshold=threshtop, peaksize=peaksize, mindist=mindist, center=center)
    bot = find_peaks(data=-left, threshold=threshbot, peaksize=peaksize, mindist=mindist, center=center)
    return top, bot
